...
object Transformation {
  ...
  fun tResize(
      height: Int? = 0,
      width: Int? = 0,
      fit: TResize.Fit? = TResize.Fit.COVER,
      background: String? = "000000",
      position: TResize.Position? = TResize.Position.CENTER,
      algorithm: TResize.Algorithm? = TResize.Algorithm.LANCZOS3,
      dpr: Number? = 1
  ): TransformationObj {
    // Call the generated class method
    return TResize().resize(height, width, fit, background, position, algorithm, dpr)
  }
   ...
   */
  @JvmOverloads
  fun tBlur(sigma: Number? = 1, dpr: Number? = 1): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tTrim(threshold: Int? = 10): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tRotate(angle: Int? = 0, background: String? = "000000"): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tDensity(density: Int? = 300): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tFlatten(background: String? = "000000"): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tTint(color: String? = "000000"): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tMedian(size: Int? = 3): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tSharpen(sigma: Number? = 1.5): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tLinear(a: Int? = 1, b: Int? = 0): TransformationObj {
   ...
   */
  @JvmOverloads
  fun tCompress(quality: Int? = 80): TransformationObj {
  ...
  fun tExtend(
      ...
      right: Int? = 10,
      background: String? = "000000",
      bordertype: TExtend.Bordertype? = TExtend.Bordertype.CONSTANT,
      dpr: Number? = 1
  ): TransformationObj {
    // Call the generated class method
    return TExtend().extend(top, left, bottom, right, background, bordertype, dpr)
  }
  ...
  @JvmOverloads
  fun tToformat(
      format: TToformat.Format? = TToformat.Format.JPEG,
      quality: TToformat.Quality? = TToformat.Quality._75
  ): TransformationObj {
    // Call the generated class method
  ...
  @JvmOverloads
  fun tMerge(
      mode: TMerge.Mode? = TMerge.Mode.OVERLAY,
      image: String? = "",
      ...
      top: Int? = 0,
      left: Int? = 0,
      gravity: TMerge.Gravity? = TMerge.Gravity.CENTER,
      blend: TMerge.Blend? = TMerge.Blend.OVER,
      tile: Boolean? = false,
   ...
   */
  @JvmOverloads
  fun awsrekDetectlabels(maximumlabels: Int? = 5, minimumconfidence: Int? = 55): TransformationObj {
   ...
   */
  @JvmOverloads
  fun awsrekModeration(minimumconfidence: Int? = 55): TransformationObj {
   ...
   *
   * @param backgroundprompt Background prompt (Default:
  ...
  fun generateBg(
      backgroundprompt: String? =
          "YSBmb3Jlc3QgZnVsbCBvZiBvYWsgdHJlZXMsd2l0aCBicmlnaHQgbGlnaHRzLCBzdW4gYW5kIGEgbG90IG9mIG1hZ2ljLCB1bHRyYSByZWFsaXN0aWMsIDhr",
      focus: GenerateBg.Focus? = GenerateBg.Focus.PRODUCT,
  ...
  fun bgExtend(
    ...
    // Call the generated class method
    return BgExtend().extend(boundingbox, prompt, guidancescale, numberofinferencesteps, seed)
  }
  ...
  fun vgGenerate(
    ...
    // Call the generated class method
    return VgGenerate().generate(generatevariationprompt, noofvariations, seed, autoscale)
  }
   ...
   */
  @JvmOverloads
  fun googlevisDetectlabels(maximumlabels: Int? = 5): TransformationObj {
   ...
   */
  @JvmOverloads
  fun imcDetect(distancepercentage: Int? = 10): TransformationObj {
  ...
  fun icCrop(
      ...
      aspectratio: String? = "",
      gravitytowards: IcCrop.Gravitytowards? = IcCrop.Gravitytowards.NONE,
      preferreddirection: IcCrop.Preferreddirection? = IcCrop.Preferreddirection.CENTER,
      objecttype: IcCrop.Objecttype? = IcCrop.Objecttype.PERSON
  ): TransformationObj {
    // Call the generated class method
    return IcCrop()
        .crop(
  ...
  fun imMask(
      ...
      detector: ImMask.Detector? = ImMask.Detector.NUMBER_PLATE,
      masktype: ImMask.Masktype? = ImMask.Masktype.FILL_BLACK
  ): TransformationObj {
    // Call the generated class method
   ...
   */
  @JvmOverloads
  fun nsfwDetect(minimumconfidence: Number? = 0.5): TransformationObj {
   ...
   */
  @JvmOverloads
  fun cosDetect(objectthresholdpercent: Int? = 50): TransformationObj {
   ...
   */
  @JvmOverloads
  fun ocrExtract(detectonly: Boolean? = false): TransformationObj {
  ...
  fun qrGenerate(
      ...
      dotstype: QrGenerate.Dotstype? = QrGenerate.Dotstype.SQUARE,
      dotsbgcolor: String? = "ffffff",
      cornersquarecolor: String? = "000000",
      cornersquaretype: QrGenerate.Cornersquaretype? = QrGenerate.Cornersquaretype.SQUARE,
      cornerdotscolor: String? = "000000",
      cornerdotstype: QrGenerate.Cornerdotstype? = QrGenerate.Cornerdotstype.DOT
  ): TransformationObj {
    // Call the generated class method
    return QrGenerate()
        .generate(
  ...
  fun shadowGen(
      ...
      shadowangle: Number? = 120,
      shadowintensity: Number? = 0.5
  ): TransformationObj {
    // Call the generated class method
    return ShadowGen().gen(backgroundimage, backgroundcolor, shadowangle, shadowintensity)
  }
  ...
  @JvmOverloads
  fun srUpscale(
      type: SrUpscale.Type? = SrUpscale.Type._2X,
      enhanceface: Boolean? = false,
      model: SrUpscale.Model? = SrUpscale.Model.PICASSO,
   ...
   * @param guidancescale Guidance Scale (controls how much the model adheres to the text prompt)
   *   (Default: 60)
   * @return The generated TransformationObj.
   */
  @JvmOverloads
  fun vertexaiGeneratebg(
    ...
    // Call the generated class method
    return VertexaiGeneratebg().generateBG(backgroundprompt, negativeprompt, seed, guidancescale)
  }
   ...
   */
  @JvmOverloads
  fun vertexaiUpscale(type: VertexaiUpscale.Type? = VertexaiUpscale.Type.X2): TransformationObj {
  ...
  fun wmRemove(
    ...
    // Call the generated class method
    return WmRemove().remove(removetext, removelogo, box1, box2, box3, box4, box5)
  }
   ...
   */
  @JvmOverloads
  fun wmcDetect(detecttext: Boolean? = false): TransformationObj {

...
class VertexaiGeneratebg {
   ...
   *
   * @param Background prompt custom (Default:
  ...
  fun generateBG(
    ...
    return TransformationObj(plugin = "vertexAi", name = "generateBG", values = values)
  }
}
...
class VertexaiRemovebg {
  ...
  fun removeBG(): TransformationObj {
    ...
    return TransformationObj(plugin = "vertexAi", name = "removeBG", values = values)
  }
}
...
class VertexaiUpscale {
  ...
  fun upscale(type: Type? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "vertexAi", name = "upscale", values = values)
  }
}

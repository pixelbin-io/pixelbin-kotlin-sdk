...
class AwsrekDetectlabels {
   ...
   */
  @JvmOverloads
  fun detectLabels(maximumlabels: Int? = null, minimumconfidence: Int? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "awsRek", name = "detectLabels", values = values)
  }
}
...
class AwsrekModeration {
   ...
   */
  @JvmOverloads
  fun moderation(minimumconfidence: Int? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "awsRek", name = "moderation", values = values)
  }
}

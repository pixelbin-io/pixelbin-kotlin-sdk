...
class TResize {
  ...
  /**
   * Position options: top, bottom, left, right, right_top, right_bottom, left_top, left_bottom,
   * center
   */
  enum class Position {
  ...
  fun resize(
    ...
    return TransformationObj(plugin = "t", name = "resize", values = values)
  }
}
...
class TFlip {
  ...
  fun flip(): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "flip", values = values)
  }
}
...
class TFlop {
  ...
  fun flop(): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "flop", values = values)
  }
}
...
class TBlur {
   ...
   */
  @JvmOverloads
  fun blur(sigma: Number? = null, dpr: Number? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "blur", values = values)
  }
}
...
class TTrim {
  ...
  fun trim(threshold: Int? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "trim", values = values)
  }
}
...
class TRotate {
   ...
   */
  @JvmOverloads
  fun rotate(angle: Int? = null, background: String? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "rotate", values = values)
  }
}
...
class TDensity {
  ...
  fun density(density: Int? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "density", values = values)
  }
}
...
class TFlatten {
  ...
  fun flatten(background: String? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "flatten", values = values)
  }
}
...
class TNegate {
  ...
  fun negate(): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "negate", values = values)
  }
}
...
class TNormalise {
  ...
  fun normalise(): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "normalise", values = values)
  }
}
...
class TGrey {
  ...
  fun grey(): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "grey", values = values)
  }
}
...
class TTint {
  ...
  fun tint(color: String? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "tint", values = values)
  }
}
...
class TMedian {
  ...
  fun median(size: Int? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "median", values = values)
  }
}
...
class TSharpen {
  ...
  fun sharpen(sigma: Number? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "sharpen", values = values)
  }
}
...
class TLinear {
   ...
   */
  @JvmOverloads
  fun linear(a: Int? = null, b: Int? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "linear", values = values)
  }
}
...
class TModulate {
  ...
  fun modulate(
    ...
    return TransformationObj(plugin = "t", name = "modulate", values = values)
  }
}
...
class TCompress {
  ...
  fun compress(quality: Int? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "compress", values = values)
  }
}
...
class TExtend {
  ...
  fun extend(
    ...
    return TransformationObj(plugin = "t", name = "extend", values = values)
  }
}
...
class TExtract {
  ...
  fun extract(
    ...
    return TransformationObj(plugin = "t", name = "extract", values = values)
  }
}
...
class TToformat {
   ...
   */
  @JvmOverloads
  fun toFormat(format: Format? = null, quality: Quality? = null): TransformationObj {
    ...
    return TransformationObj(plugin = "t", name = "toFormat", values = values)
  }
}
...
class TMerge {
  ...
  /**
   * Gravity options: northwest, north, northeast, east, center, west, southwest, south, southeast,
   * custom
   */
  enum class Gravity {
  ...
  /**
   * Blend options: over, in, out, atop, dest, dest-over, dest-in, dest-out, dest-atop, xor, add,
   * saturate, multiply, screen, overlay, darken, lighten, colour-dodge, color-dodge, colour-burn,
  ...
  fun merge(
    ...
    return TransformationObj(plugin = "t", name = "merge", values = values)
  }
}

...
class QrGenerate {
    ...
    enum class Dotstype {
        ROUNDED {
            override fun toString(): String = "rounded"
        },
        DOTS {
            override fun toString(): String = "dots"
        },
        CLASSY {
            override fun toString(): String = "classy"
        },
        CLASSY_ROUNDED {
            override fun toString(): String = "classy-rounded"
        },
        SQUARE {
            override fun toString(): String = "square"
        },
        EXTRA_ROUNDED {
            override fun toString(): String = "extra-rounded"
        },
    }

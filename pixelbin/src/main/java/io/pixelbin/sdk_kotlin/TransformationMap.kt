...
internal object TransformationMap {
    val hashMap: HashMap<String, TransformationObj> =
        hashMapOf(
            ...
            "bg.extend" to Transformation.bgExtend(),
            ...
            "im.mask" to Transformation.imMask(),
            ...
            "vsr.upscale" to Transformation.vsrUpscale(),

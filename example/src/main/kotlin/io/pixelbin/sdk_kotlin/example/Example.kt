...
suspend fun uploadFilePixelBin(file: File): Result<Any> {
  ...
  val signedDetails =
      SignedDetails(
          url =
              "https://api.pixelbin.io/service/public/assets/v1.0/signed-multipart?pbs=174b1c38c4f7423cdfc5c92ed42410db4b27b1c6d3239ee5e22eb96268346922&pbe=1725870809434&pbt=9310166e-34b1-43a7-93a8-e659c371230f&pbo=5814399&pbu=f27b2a67-199e-4f11-8938-04a2945469af",
          fields = fields)
...
object ResourceLoader {
  fun loadFileFromResources(fileName: String): File? {
    ...
    return inputStream?.let {
      ...
      tempFile.outputStream().use { outputStream -> it.copyTo(outputStream) }
      tempFile
    }
  }
}
